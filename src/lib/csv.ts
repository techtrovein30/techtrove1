 ...
 * csv.ts
 * -------
 * Reusable CSV export helpers with formula injection defense.
 *
 * Defends against CSV/formula injection (CWE-1236): fields that begin with
 * characters interpreted as formulas (=, +, -, @, tab, CR, LF) are prefixed
