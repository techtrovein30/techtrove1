    ...
    <div className="reveal-up">
      <section className="border-b border-edge bg-surface/50">
        <div className="mx-auto max-w-7xl px-4 pb-14 pt-32 sm:px-6 md:pb-16 md:pt-40 lg:px-8">
          ...
          <h1 className="display mt-3 text-5xl text-foreground sm:text-7xl">Rulebook</h1>
          <p className="mt-4 max-w-xl text-sm leading-relaxed text-muted">
            The ground rules for TechTrove. Event-specific rules are published on each event page
      ...
      <section className="mx-auto max-w-5xl space-y-12 px-4 py-14 pb-20 sm:px-6 md:py-20 lg:px-8">
        {ruleSections.map((section, i) => (
          <article
            key={section.id}
            className="grid gap-6 border-b border-edge pb-10 last:border-b-0 md:grid-cols-[14rem_1fr] md:gap-12"
          >
            <div>
              <span aria-hidden className="display outline-text block text-4xl">
