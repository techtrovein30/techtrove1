            ...
            <dl className="grid grid-cols-2 gap-px border border-edge bg-edge sm:grid-cols-4">
              <div className="bg-surface p-5">
                ...
                <dd className="display mt-3 text-3xl">
                  {isSoloTeam ? "1–2" : (event.requiredPlayers ?? "TBA")}
                </dd>
              </div>
              {isSport && (
                <div className="bg-surface p-5">
              ...
              <div className="bg-surface p-5">
                ...
                <dd className="display mt-3 text-3xl capitalize">
                  {isSoloTeam ? "Solo / Team" : (event.registrationType ?? "TBA")}
                </dd>
              </div>
            </dl>
              ...
              <dl className="mt-6 space-y-3 border-t border-edge pt-6 text-sm">
                <div className="flex justify-between gap-4">
                  ...
                  <dd className="font-medium text-foreground">
                    {isIndividual ? "Individual" : isSoloTeam ? "1 – 2 players" : `${event.requiredPlayers ?? "-"} players`}
                  </dd>
                </div>
                {isSport && !isSoloTeam && (
                  <div className="flex justify-between gap-4">
