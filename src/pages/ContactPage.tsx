...
const channels = [
  ...
  },
  {
    ...
    value: (
      <span className="flex flex-col space-y-3 mt-2">
        {siteConfig.contact.phones.map((p) => (
          <span key={p.number} className="flex flex-col leading-tight mb-2 last:mb-0">
  ...
  },
  {
    ...
    href: "https://chat.whatsapp.com/F3ca20zjmVoJcu6FCYGPSZ",
    color: "text-emerald-400",
    copyable: false,
  },
  {
