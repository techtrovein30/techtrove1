...
import { ArrowRight, Trophy, Code2 } from "lucide-react";
...
export function HomePage() {
  ...
  return (
    <div className="reveal-up">
      ...
      <section className="grain relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 pb-16 pt-32 sm:px-6 md:pb-24 md:pt-44 lg:grid-cols-[1.25fr_1fr] lg:items-center lg:gap-12 xl:gap-16">
          <div>
            ...
            <h1 className="display mt-4 text-[clamp(3rem,9vw,6.25rem)] animated-gradient-text drop-shadow-2xl">
              TechTrove 3.0
            </h1>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                to="/register?day=day-1"
                className="group rounded-full inline-flex items-center justify-center gap-3 bg-primary px-7 py-4 text-xs font-semibold uppercase tracking-[0.18em] text-white transition-all shadow-[0_0_20px_rgba(124, 58, 237,0.4)] hover:shadow-[0_0_30px_rgba(124, 58, 237,0.7)] hover:bg-primary-soft"
              >
                <Trophy className="h-4 w-4" aria-hidden />
                <span className="flex flex-col items-start leading-tight">
                  <span>Register · Sports</span>
                  <span className="text-[9px] font-medium uppercase tracking-[0.14em] text-white/70">
                    Day 1 · Carrom, Chess &amp; team games
                  </span>
                </span>
              </Link>
              <Link
                to="/register?day=day-2"
                className="group rounded-full inline-flex items-center justify-center gap-3 border border-primary/50 bg-primary/10 px-7 py-4 text-xs font-semibold uppercase tracking-[0.18em] text-primary-soft transition-all hover:border-primary hover:bg-primary/20 hover:shadow-[0_0_30px_rgba(124, 58, 237,0.5)]"
              >
                <Code2 className="h-4 w-4" aria-hidden />
                <span className="flex flex-col items-start leading-tight">
                  <span>Register · Tech &amp; Non-Tech</span>
                  <span className="text-[9px] font-medium uppercase tracking-[0.14em] text-primary-soft/70">
                    Day 2 · Technical + Non-Technical events
                  </span>
                </span>
              </Link>
            </div>
            <Link
              to="/events"
              className="mt-4 inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-muted transition-colors hover:text-primary-soft"
            >
              Explore all events <ArrowRight className="h-3.5 w-3.5" aria-hidden />
            </Link>
          </div>
        ...
        <div className="relative grid gap-12 lg:grid-cols-2 lg:gap-8 lg:items-center">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-sm leading-relaxed text-muted sm:text-base">
              ...
              the field. Day 2 opens up the technical and creative tracks of the symposium.
            </p>
      ...
      {/* Day overview */}
      <section aria-label="The two days" className="mx-auto max-w-7xl px-4 py-20 sm:px-6 md:py-24 lg:px-8">
        <ol>
          {days.map((day, i) => {
            const content = (
              <>
      ...
      <section className="grain relative overflow-hidden border-t border-edge">
        ...
        <div className="relative z-10 mx-auto flex max-w-3xl flex-col items-center px-4 py-24 text-center sm:px-6 md:py-32">
          ...
          <p className="mt-5 max-w-md text-sm leading-relaxed text-muted sm:text-base">
            Sports or Tech? Choose your track below. Day 2 registrations are open — register early
            so you don't miss the problem-statement drops.
          </p>
          <div className="mt-9 flex flex-col items-center gap-3 sm:flex-row">
            <Link
              to="/register?day=day-1"
              className="rounded-full inline-flex items-center justify-center gap-3 bg-primary px-9 py-4 text-xs font-semibold uppercase tracking-[0.18em] text-white transition-all shadow-[0_0_20px_rgba(124, 58, 237,0.4)] hover:shadow-[0_0_30px_rgba(124, 58, 237,0.7)] hover:bg-primary-soft"
            >
              <Trophy className="h-4 w-4" aria-hidden />
              Sports · Day 1
            </Link>
            <Link
              to="/register?day=day-2"
              className="rounded-full inline-flex items-center justify-center gap-3 border border-primary/50 bg-primary/10 px-9 py-4 text-xs font-semibold uppercase tracking-[0.18em] text-primary-soft transition-all hover:border-primary hover:bg-primary/20 hover:shadow-[0_0_30px_rgba(124, 58, 237,0.5)]"
            >
              <Code2 className="h-4 w-4" aria-hidden />
              Tech &amp; Non-Tech · Day 2
            </Link>
